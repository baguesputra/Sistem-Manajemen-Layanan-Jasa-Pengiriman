              ...
              <form id="quickForm" action="proses.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="asal" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Kota Asal">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kota Tujuan</label>
                    <input type="text" name="tujuan" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Kota Tujuan">
                  </div>
                  <div class="form-group">
